...
class SampleSubtree():
    ...
    def __init__(self, mname, xhats, root_scen, starting_stage, branching_factors,
        ...
        #Create an amalgaator object to solve the subtree problem
        self._create_amalgaator()
    ...
    def _create_amalgaator(self):
        '''
        This method attaches an Amalgaator object to a sample subtree.
        ...
        self.ama = amalgaator.Amalgaator(ama_options, scen_names,
                                           self.scenario_creator,
                                           self.refmodel.kw_creator,
                                           denouement,
                                           verbose = False)
    def run(self):
        #Running the Amalgaator and attaching the result to the SampleSubtree object
...
if __name__ == "__main__":
    ...
    ama = amalgaator.from_module(mname, ama_options,use_command_line=False)
    ama.run()
