...
class MMWConfidenceIntervals:
    ...
    def __init__(
        ...
        if ama._bool_option(cfg, "EF_2stage"):
            ...
            raise RuntimeError(
                "Only EF is currently supported; "
    ...
    def run(self, confidence_level=0.95):
        ...
        if self.multistage:
            sampling_branching_factors = ciutils.branching_factors_from_numscens(
        ...
        for i in range(num_batches):
            ...
            gap_options = (
                {"seed": start, "branching_factors": sampling_branching_factors}
                if self.multistage
                else None
            )
