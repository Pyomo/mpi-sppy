...
class XhatXbar(mpisppy.extensions.xhatbase.XhatBase):
    ...
    # ==========
    def xhat_tryit(self, verbose=False, restore_nonants=True):
    ...
    def post_everything(self):
        ...
        obj = self.xhat_tryit(verbose=self.verbose, restore_nonants=restore_nonants)
