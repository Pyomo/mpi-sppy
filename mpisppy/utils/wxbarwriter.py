...
class WXBarWriter(mpisppy.extensions.extension.Extension):
    ...
    def post_everything(self):
        if self.w_fname:
            fname = self.w_fname
            mpisppy.utils.wxbarutils.write_W_to_file(
                self.PHB, fname, sep_files=self.sep_files
            )
