...
def add_multistage_options(cylinder_dict, all_nodenames, branching_factors):
    ...
    if branching_factors is not None:
        if hasattr(cylinder_dict["opt_kwargs"], "options"):
            cylinder_dict["opt_kwargs"]["options"]["branching_factors"] = (
                branching_factors
            )
...
def extension_adder(hub_dict, ext_class):
    ...
    if (
        "extensions" not in hub_dict["opt_kwargs"]
        or hub_dict["opt_kwargs"]["extensions"] is None
    ):
    ...
    if _hasit(cfg, "ph_track_progress") and cfg.ph_track_progress:
        ...
        for t_var in t_vars:
            if _hasit(cfg, f"track_{t_var}"):
                ...
                if (
                    trval in {1, 4}
                    or (not spoke and trval in {2, 5})
                    or (spoke and trval in {3, 6})
                ):
...
def lagrangian_spoke(
    ...
    if cfg.lagrangian_iter0_mipgap is not None:
        lagrangian_spoke["opt_kwargs"]["options"]["iter0_solver_options"]["mipgap"] = (
            cfg.lagrangian_iter0_mipgap
        )
    if cfg.lagrangian_iterk_mipgap is not None:
        lagrangian_spoke["opt_kwargs"]["options"]["iterk_solver_options"]["mipgap"] = (
...
def lagranger_spoke(
    ...
    if cfg.lagranger_iter0_mipgap is not None:
        lagranger_spoke["opt_kwargs"]["options"]["iter0_solver_options"]["mipgap"] = (
            cfg.lagranger_iter0_mipgap
        )
    if cfg.lagranger_iterk_mipgap is not None:
        lagranger_spoke["opt_kwargs"]["options"]["iterk_solver_options"]["mipgap"] = (
            cfg.lagranger_iterk_mipgap
        )
...
def subgradient_spoke(
    ...
    if cfg.subgradient_iter0_mipgap is not None:
        subgradient_spoke["opt_kwargs"]["options"]["iter0_solver_options"]["mipgap"] = (
            cfg.subgradient_iter0_mipgap
        )
    if cfg.subgradient_iterk_mipgap is not None:
        subgradient_spoke["opt_kwargs"]["options"]["iterk_solver_options"]["mipgap"] = (
            cfg.subgradient_iterk_mipgap
        )
...
def xhatlooper_spoke(
    ...
    xhatlooper_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  #  no bundles for xhat
    )
    xhatlooper_dict["opt_kwargs"]["options"]["xhat_looper_options"] = {
        "xhat_solver_options": xhatlooper_dict["opt_kwargs"]["options"][
...
def xhatxbar_spoke(
    ...
    xhatxbar_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  # no bundles for xhat
    )
    xhatxbar_dict["opt_kwargs"]["options"]["xhat_xbar_options"] = {
        "xhat_solver_options": xhatxbar_dict["opt_kwargs"]["options"][
            "iterk_solver_options"
        ],
        "dump_prefix": "delme",
        "csvname": "looper.csv",
...
def xhatshuffle_spoke(
    ...
    xhatshuffle_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  # no bundles for xhat
    )
    xhatshuffle_dict["opt_kwargs"]["options"]["xhat_looper_options"] = {
        "xhat_solver_options": xhatshuffle_dict["opt_kwargs"]["options"][
            "iterk_solver_options"
        ],
        "dump_prefix": "delme",
        "csvname": "looper.csv",
    ...
    if _hasit(cfg, "add_reversed_shuffle"):
        xhatshuffle_dict["opt_kwargs"]["options"]["xhat_looper_options"]["reverse"] = (
            cfg.add_reversed_shuffle
        )
    if _hasit(cfg, "add_reversed_shuffle"):
        xhatshuffle_dict["opt_kwargs"]["options"]["xhatshuffle_iter_step"] = (
            cfg.xhatshuffle_iter_step
        )
...
def xhatspecific_spoke(
    ...
    xhatspecific_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  # no bundles for xhat
    )
...
def xhatlshaped_spoke(
    ...
    xhatlshaped_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  # no bundles for xhat
    )
...
def slammax_spoke(
    ...
    slammax_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  # no bundles for slamming
    )
    return slammax_dict
...
def slammin_spoke(
    ...
    slammin_dict["opt_kwargs"]["options"]["bundles_per_rank"] = (
        0  # no bundles for slamming
    )
    return slammin_dict
...
def ph_ob_spoke(
    ...
    if cfg.ph_ob_rho_rescale_factors_json is not None:
        ph_ob_spoke["opt_kwargs"]["options"]["ph_ob_rho_rescale_factors_json"] = (
    ...
    if cfg.ph_ob_gradient_rho:
        ph_ob_spoke["opt_kwargs"]["options"]["ph_ob_gradient_rho"] = dict()
        ph_ob_spoke["opt_kwargs"]["options"]["ph_ob_gradient_rho"]["cfg"] = cfg
