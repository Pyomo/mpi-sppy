...
def _common_args(inparser):
    ...
    parser.add_argument(
        "--proximal-linearization-tolerance",
...
def lagranger_args(inparser):
    ...
    parser.add_argument(
        "--lagranger-rho-rescale-factors-json",
...
def cross_scenario_cuts_args(inparser):
    ...
    parser.add_argument(
        "--cross-scenario-iter-cnt",
        help="cross scen check bound improve iterations " "(default 4)",
