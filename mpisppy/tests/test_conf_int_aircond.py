...
class Test_confint_aircond(unittest.TestCase):
    ...
    def test_xhat_eval_evaluate_one(self):
        ...
        self.assertEqual(obj, 1500.0) # rebaselined 27 Dec 2021
    ...
    def test_MMW_running(self):
        ...
        self.assertEqual((s,bound), (30.0, 69.0))
    ...
    def test_gap_estimators(self):
        ...
        self.assertEqual((G,s), (13.0, 27.2))  # rebaselined 27 Dec 2021 (see also 5 dec)
    ...
    def test_indepscens_seqsampling_running(self):
        ...
        self.assertEqual((T,ub), (22, 120.0))
    ...
    def test_zhat4xhat(self):
        ...
        self.assertEqual(z2, 910.)
        e2 = round_pos_sig(eps_z, 2)
        self.assertEqual(e2, 75.)
        #print(f"*** {z2 =} {e2 =}")
