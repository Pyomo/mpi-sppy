...
class Test_pickle_bundles(unittest.TestCase):
    ...
    def test_chain(self):
        ...
        cmdstr = (
            f'python aircond_cylinders.py --branching-factors="{self.BPF}" --unpickle-bundles-dir={self.tempdir_name} --scenarios-per-bundle={self.SPB} {self.EC} '
