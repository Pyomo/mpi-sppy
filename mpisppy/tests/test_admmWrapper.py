...
class TestAdmmWrapper(unittest.TestCase):
    ...
    def test_values(self):
        command_line_pairs = [
            (
                f"mpiexec -np 3 python -u -m mpi4py distr_admm_cylinders.py --num-scens 3 --default-rho 10 --solver-name {solver_name} --max-iterations 50 --xhatxbar --lagrangian --rel-gap 0.01 --ensure-xhat-feas",
