...
mpiexec --oversubscribe -np 9 python -m mpi4py aircond_cylinders.py  --branching-factors 5 4 3 --bundles-per-rank=0 --max-iterations=50 --default-rho=1.0 --solver-name=${SOLVERNAME} --rel-gap=0.001 --abs-gap=2 --start-ups --max-solver-threads 2 --max-stalled-iters 10
