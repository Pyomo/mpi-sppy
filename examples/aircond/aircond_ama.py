...
"""
An example of using amalgaator with 3 cylinders for a multistage problem
To execute this:
...
def main():
    ...
    ama_options = amalgaator.Amalgaator_parser(options, aircond.inparser_adder)
    
    #Here, we need to change something specified by the command line
    #That's why we cannot use amalgaator.from_module
    ...
    ama =amalgaator.Amalgaator(ama_options, 
                                 scenario_names, 
