...
mpiexec -n 6 python -m mpi4py ${EMLOC}/emprise_cylinders.py --max-solver-threads=2 --bundles-per-rank=1 --max-iterations=10 --default-rho=750 --with-xhatshuffle --with-lagrangian --solver-name=${SOLVERNAME} --with-display-convergence-detail
