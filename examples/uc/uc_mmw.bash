...
python -m mpisppy.confidence_intervals.mmw_conf uc_funcs uc_cyl_nonants.npy ${SOLVERNAME} --MMW-num-batches 5 --MMW-batch-size 10 --UC-count-for-path 100 --confidence-level 0.9 --start-scen 10
