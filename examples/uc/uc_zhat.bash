...
python -m mpisppy.confidence_intervals.zhat4xhat uc_funcs uc_cyl_nonants.npy --solver-name ${SOLVERNAME} --branching-factors 3 --UC-count-for-path 100 --num-samples 5
