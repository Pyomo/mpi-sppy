...
python -m mpi4py ../../../mpisppy/generic_cylinders.py --module-name ../../../mpisppy/mps_module --mps-files-directory $ODIR --solver-name ${SOLVER} --max-iterations 1 --default-rho 1 
