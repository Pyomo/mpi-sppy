...
mpiexec -np 3 python -m mpi4py agnostic_gams_cylinders.py --num-scens 3 --default-rho 0.5 --solver-name $SOLVERNAME --max-iterations=10 --xhatshuffle --lagrangian --rel-gap 0.01 #--display-progress 
