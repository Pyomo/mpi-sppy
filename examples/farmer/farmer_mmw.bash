...
python -m mpisppy.confidence_intervals.mmw_conf afarmer farmer_cyl_nonants.spy.npy ${SOLVERNAME} --MMW-num-batches 5 --MMW-batch-size 10 --alpha 0.9 --start-scen 10
