...
python -m mpisppy.confidence_intervals.zhat4xhat farmer --xhatpath farmer_cyl_nonants.npy --EF-solver-name ${SOLVERNAME} --branching-factors 10 --num-samples 5 --confidence-level 0.95
