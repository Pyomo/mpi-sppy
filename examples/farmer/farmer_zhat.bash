...
python -m mpisppy.confidence_intervals.zhat4xhat --xhatpath farmer farmer_cyl_nonants.npy --solver-name ${SOLVERNAME} --branching-factors 10 --num-samples 5 --confidence-level 0.95
