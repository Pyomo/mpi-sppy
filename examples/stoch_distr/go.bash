...
#mpiexec -np 3 python -u -m mpi4py stoch_distr_admm_cylinders.py --num-stoch-scens 3 --num-admm-subproblems 2 --default-rho 10 --solver-name cplex_direct --max-iterations 50 --scalable --xhatxbar --lagrangian --mnpr 5 --ensure-xhat-feas
