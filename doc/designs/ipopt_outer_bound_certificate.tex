...
\noindent
Everything above the rule is in \texttt{mpisppy/utils/dual\_certificate.py},
...
the \texttt{None} propagated across both.  The spoke driving all of it is
\texttt{mpisppy/cylinders/ipopt\_outer\_bound.py}.
