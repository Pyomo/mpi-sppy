  ...
  \begin{itemize}
    ...
    \item The hub cylinder now
      ...
      \item does some output, and
        \item decides when to shut down and signals all other cylinders to do so.
        \end{itemize}
  \end{itemize}
  \item This allows more flexibility to have spokes that tighten variable bounds, find and adjust parameter values (e.g. $\rho$), and compute upper/lower objective function bounds.
\end{frame}
